...
/* Code copied from http://www.raspberry-projects.com/pi/programming-in-c/uart-serial-port/using-the-uart
 *
 */
...
//    int count = write(uart0_filestream, &tx_buffer[0], (p_tx_buffer - &tx_buffer[0]));              //Filestream, bytes to write, number of bytes to write
    int count = write(uart0_filestream, &byteToTransmit, ONE_BYTE);              //Filestream, bytes to write, number of bytes to write
    if (count < 0)
    {
      return UART_FAILURE;
